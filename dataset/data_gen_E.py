#!/usr/bin/env python
# coding: utf-8
# Type-D: internal bricks: true; mass: un-equal; interactions: ; time: 10s; number: 20
...
# Global Variables
SIMULATION_TIME = 16 # Total simulation time in seconds
...
SPRING_MAX_LENGTH = 120
ROD_LENGTH = 60
ROPE_MAX_LENGTH = 100
MAX_INIT_VELOCITY = 60
BRICK_NUM = 15

INPUT_DIR = "./"
OUTPUT_DIR = "./converted/E"
...
if __name__ == "__main__":
    ...
    VIDEO_FILENAME = f"type_E_{datetime.now().strftime('%Y%m%d_%H%M%S')}.mp4"
